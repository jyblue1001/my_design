...
N 420 -120 480 -120 {lab=GNDA}
C {devices/ipin.sym} 90 -420 2 1 {name=p1 lab=Vin+}
C {devices/opin.sym} 640 -560 0 0 {name=p5 lab=Vout}
C {devices/ipin.sym} 620 -420 2 0 {name=p2 lab=Vin-}
