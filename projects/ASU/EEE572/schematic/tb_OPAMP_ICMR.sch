...
N 3870 -2670 3870 -2570 {lab=VIN_P}
N 3870 -2510 3870 -2460 {lab=GND}
N 4740 -2770 4740 -2710 {lab=AMP_OUT}
N 4740 -2650 4740 -2610 {lab=GND}
N 4230 -2750 4230 -2580 {lab=AMP_OUT}
N 4230 -2580 4540 -2580 {lab=AMP_OUT}
N 4540 -2770 4540 -2580 {lab=AMP_OUT}
...
C {devices/vsource.sym} 3870 -2540 0 1 {name=V3 value=0.9 savecurrent=false
* 0.9 1.44 * 1.24 
* 1.34 1.25  "sin(0.9 0.001 200k)"}
C {devices/gnd.sym} 3870 -2460 0 1 {name=V4 value="pulse(1.241 1.239 0ns 10ns 10ns 240ns 500ns)" savecurrent=false
* * 100k)"
