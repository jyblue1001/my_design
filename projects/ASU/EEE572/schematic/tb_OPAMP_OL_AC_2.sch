...
N 4540 -3040 4540 -3000 {lab=VDD}
N 4540 -2900 4540 -2860 {lab=GND}
N 4640 -2950 4850 -2950 {lab=AMP_OUT}
...
C {simulator_commands_shown.sym} 5330 -2890 0 0 {name=COMMANDS
simulator=ngspice
only_toplevel=false 
value="
.options method=gear
...
"}
C {devices/gnd.sym} 4540 -2860 0 1 {name=l29 lab=GND}
