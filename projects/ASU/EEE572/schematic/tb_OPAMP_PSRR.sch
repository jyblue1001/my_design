...
N 3870 -2740 3870 -2690 {lab=VIN_P}
N 3870 -2630 3870 -2580 {lab=GND}
N 4230 -2750 4230 -2660 {lab=AMP_OUT}
N 4740 -2770 4740 -2710 {lab=AMP_OUT}
N 4740 -2650 4740 -2610 {lab=GND}
N 4230 -2660 4230 -2540 {lab=AMP_OUT}
N 4230 -2540 4550 -2540 {lab=AMP_OUT}
N 4550 -2770 4550 -2540 {lab=AMP_OUT}
N 4360 -2870 4360 -2820 {lab=#net1}
C {sky130_fd_pr/corner.sym} 5270 -2160 0 0 {name=CORNER only_toplevel=false corner=tt}
...
C {devices/vsource.sym} 4360 -2900 0 1 {name=V2 value="1.8 AC 1" savecurrent=false
* 0.9 1.44 * 1.24 
* 1.34 1.25  "sin(0.9 0.001 200k)"}
C {lab_pin.sym} 4630 -2770 0 1 {name=p2 lab=AMP_OUT}
C {vdd.sym} 4360 -2970 0 0 {name=l1 lab=VDD}
C {lab_pin.sym} 3870 -2790 0 0 {name=p4 lab=VIN_P}
C {OPAMP.sym} 4360 -2770 0 0 {name=x1}
C {devices/vsource.sym} 3870 -2660 0 1 {name=V3 value=0.9 savecurrent=false
* 0.9 1.44 * 1.24 
* 1.34 1.25  "sin(0.9 0.001 200k)"}
C {devices/gnd.sym} 3870 -2580 0 1 {name=V4 value="pulse(1.241 1.239 0ns 10ns 10ns 240ns 500ns)" savecurrent=false
* * 100k)"
