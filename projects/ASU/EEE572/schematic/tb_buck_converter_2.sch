...
S {}
E {}
B 2 4140 -1970 4400 -1780 {flags=graph
...
x2=0.00045}
B 2 3260 -1970 3520 -1780 {flags=graph
...
color=7
node=v_diode}
B 2 2970 -2340 3230 -2150 {flags=graph
...
color=6
node=sw_in}
B 2 2970 -1750 3230 -1560 {flags=graph
...
color=6
node=i(@s1[i])}
B 2 3260 -1750 3520 -1560 {flags=graph
...
color=7
node=i(@s2[i])}
B 2 2970 -1970 3230 -1780 {flags=graph
...
B 2 3550 -1750 3810 -1560 {flags=graph
...
color=9
node=i(l53)}
B 2 3550 -1970 3810 -1780 {flags=graph
...
B 2 3840 -1750 4100 -1560 {flags=graph
...
color=11
node=i(@c6[i])}
B 2 3840 -1970 4100 -1780 {flags=graph
...
color=7
node=x6.v_top}
T {Voltage} 2820 -1910 0 0 0.6 0.6 {}
T {Current} 2820 -1680 0 0 0.6 0.6 {}
T {Switch} 3040 -2070 0 0 0.6 0.6 {}
T { Diode
(Switch)} 3340 -2070 0 0 0.6 0.6 {}
T {Inductor} 3620 -2070 0 0 0.6 0.6 {}
T {Capacitor} 3900 -2070 0 0 0.6 0.6 {}
T {Load Resistor} 4170 -2070 0 0 0.6 0.6 {}
T {Duty Cycle} 2790 -2270 0 0 0.6 0.6 {}
...
C {devices/vsource.sym} 2810 -1110 0 0 {name=V1 value="pwl(0 0 1us 0 1.2us 1.8)" savecurrent=false
* 1.8}
...
C {bgr_ref_volt.sym} 2240 -920 0 1 {name=x6}
