...
N 490 -950 490 -910 {lab=V_TOP}
N 290 -850 290 -760 {lab=start_up}
N 290 -1060 290 -980 {
lab=VDDA}
N 250 -950 290 -950 {lab=VDDA}
N 250 -1020 250 -950 {lab=VDDA}
N 250 -1020 290 -1020 {lab=VDDA}
N 290 -920 290 -850 {lab=start_up}
N 490 -950 580 -950 {lab=V_TOP}
N 580 -950 580 -900 {lab=V_TOP}
N 580 -900 820 -900 {lab=V_TOP}
N 290 -880 450 -880 {lab=start_up}
N 290 -260 540 -260 {lab=GNDA}
N 880 -950 880 -810 {lab=V_TOP}
N 820 -950 820 -900 {lab=V_TOP}
N 490 -730 700 -730 {lab=Vin-}
N 250 -660 290 -660 {lab=GNDA}
N 250 -730 250 -660 {lab=GNDA}
N 250 -730 290 -730 {lab=GNDA}
N 290 -700 290 -630 {lab=GNDA}
N 290 -340 290 -260 {lab=GNDA}
N 490 -880 530 -880 {lab=VDDA}
N 530 -930 530 -880 {lab=VDDA}
N 290 -630 290 -340 {lab=GNDA}
N 330 -950 490 -950 {lab=V_TOP}
N 290 -790 350 -790 {lab=start_up}
N 350 -790 350 -730 {lab=start_up}
N 330 -730 350 -730 {lab=start_up}
N 490 -850 490 -730 {lab=Vin-}
...
C {lab_wire.sym} 980 -680 2 0 {name=p6 sig_type=std_logic lab=Vin+}
C {lab_wire.sym} 790 -680 2 1 {name=p1 sig_type=std_logic lab=Vin-}
...
C {sky130_fd_pr/pfet_01v8.sym} 310 -950 0 1 {name=M6
W=2
L=0.15
nf=1
mult=1
...
C {devices/lab_pin.sym} 290 -880 2 1 {name=p7 sig_type=std_logic lab=start_up}
C {lab_wire.sym} 490 -730 2 1 {name=p3 sig_type=std_logic lab=Vin-}
C {lab_wire.sym} 490 -950 0 0 {name=p8 sig_type=std_logic lab=V_TOP}
C {sky130_fd_pr/pfet_01v8.sym} 470 -880 0 0 {name=M4
W=2
L=0.15
nf=1
mult=1
...
C {devices/lab_pin.sym} 800 -740 2 1 {name=p12 sig_type=std_logic lab=GNDA}
