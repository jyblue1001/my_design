...
S {}
E {}
B 2 1400 -1230 2820 -160 {flags=graph
y1=-0.15
y2=1.9
ypos1=0
ypos2=2
...
N 1190 -330 1340 -330 {
lab=osc}
C {devices/vsource.sym} 850 -740 0 0 {name=Vdd value=1.8 savecurrent=false}
C {devices/vdd.sym} 850 -770 0 0 {name=l3 lab=VDD}
C {devices/gnd.sym} 850 -710 0 0 {name=l4 lab=GND}
C {sky130_fd_pr/corner.sym} 370 -800 0 0 {name=CORNER only_toplevel=false corner=ss}
C {devices/code.sym} 600 -810 0 0 {name=STIMULI only_toplevel=false value="
