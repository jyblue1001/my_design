...
N 110 -330 110 -310 {
lab=GND}
C {devices/lab_pin.sym} 370 -260 0 0 {name=p1 sig_type=std_logic lab=Vin}
C {devices/vdd.sym} 430 -320 0 0 {name=l1 lab=VDD}
C {devices/gnd.sym} 430 -200 0 0 {name=l2 lab=GND}
...
C {devices/lab_pin.sym} 510 -260 2 0 {name=p3 sig_type=std_logic lab=Vout}
