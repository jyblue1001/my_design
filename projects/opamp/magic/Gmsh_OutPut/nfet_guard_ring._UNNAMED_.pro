...
Group{
	...
	influx = Region[15];
	fixtemp = Region[16];
	Vol_The = Region[{Local_Interconnect_Contact, Dielec_Local_Interconnect_Contact, Tap, Dielec_Tap, Diffusion, Dielec_Diffusion, Polysilicon, Dielec_Polysilicon, Local_Interconnect, Dielec_Local_Interconnect, Metal_Contact, Dielec_Metal_Contact, Metal_1, Dielec_Metal_1}];
