...
color="6 7"
node="i(@m.x1.xm28.msky130_fd_pr__pfet_01v8[id])
i(@m.x1.xm14.msky130_fd_pr__nfet_01v8[id])"}
B 2 5230 -360 5950 130 {flags=graph
...
color="6 7"
node="i(@m.x1.xm29.msky130_fd_pr__pfet_01v8[id])
i(@m.x1.xm23.msky130_fd_pr__nfet_01v8[id])"}
B 2 5230 300 5950 790 {flags=graph
...
node="\\"v_cmfb_s1 x2.x -\\"
\\"x2.x v_cmfb_s2 -\\""}
B 2 6050 300 6770 790 {flags=graph
...
node="\\"v_cmfb_s3 x2.y -\\"
\\"x2.y v_cmfb_s4 -\\""}
B 2 4430 300 5150 790 {flags=graph
...
N 3510 -1980 4070 -1980 {lab=VOUT-}
N 3510 -2060 4070 -2060 {lab=VOUT+}
N 3880 -2110 3880 -2060 {lab=VOUT+}
N 3880 -1980 3880 -1930 {lab=VOUT-}
N 2690 -1910 3210 -1910 {lab=TAIL_CUR_MIR_BIAS}
N 2690 -1930 3210 -1930 {lab=ERR_AMP_CUR_BIAS}
N 2690 -1950 3210 -1950 {lab=ERR_AMP_REF}
N 2690 -1970 3210 -1970 {lab=VB3_CUR_BIAS}
N 2690 -1990 3210 -1990 {lab=VB2_CUR_BIAS}
N 2690 -2010 3210 -2010 {lab=VB1_CUR_BIAS}
N 2690 -2030 3210 -2030 {lab=V_CMFB_S4}
N 2690 -2050 3210 -2050 {lab=V_CMFB_S3}
N 2690 -2070 3210 -2070 {lab=V_CMFB_S2}
N 2690 -2090 3210 -2090 {lab=V_CMFB_S1}
N 2990 -2110 3210 -2110 {lab=VIN-}
N 2990 -2300 2990 -2110 {lab=VIN-}
N 2840 -2300 2990 -2300 {lab=VIN-}
N 3060 -2130 3210 -2130 {lab=VIN+}
N 3060 -2380 3060 -2130 {lab=VIN+}
N 2840 -2380 3060 -2380 {lab=VIN+}
...
"}
C {lab_pin.sym} 4070 -2060 2 0 {name=p6 lab=VOUT+}
C {lab_pin.sym} 4070 -1980 0 1 {name=p7 lab=VOUT-}
C {lab_pin.sym} 2840 -2380 2 1 {name=p10 lab=VIN+}
C {lab_pin.sym} 2840 -2300 0 0 {name=p11 lab=VIN-}
C {devices/gnd.sym} 2540 -1860 0 0 {name=l2 lab=GND}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 3880 -2140 2 1 {name=C1 model=cap_mim_m3_1 W=23 L=23 MF=1 spiceprefix=X}
C {devices/gnd.sym} 3880 -2170 2 1 {name=l13 lab=GND}
C {sky130_fd_pr/cap_mim_m3_1.sym} 3880 -1900 0 0 {name=C2 model=cap_mim_m3_1 W=23 L=23 MF=1 spiceprefix=X}
C {devices/gnd.sym} 3880 -1870 0 0 {name=l14 lab=GND}
C {devices/vdd.sym} 2540 -2140 0 0 {name=l1 lab=VDD}
C {ref_volt_cur_gen_dummy.sym} 2540 -2000 0 0 {name=x1}
C {two_stage_opamp_dummy.sym} 3360 -2020 0 0 {name=x2}
C {lab_pin.sym} 2880 -1950 0 1 {name=p5 lab=ERR_AMP_REF}
C {lab_pin.sym} 2880 -2050 0 1 {name=p8 lab=V_CMFB_S3}
C {lab_pin.sym} 2880 -2010 0 1 {name=p12 lab=VB1_CUR_BIAS}
C {lab_pin.sym} 2880 -1910 0 1 {name=p13 lab=TAIL_CUR_MIR_BIAS}
C {lab_pin.sym} 2880 -2090 0 1 {name=p14 lab=V_CMFB_S1}
C {lab_pin.sym} 2880 -1930 0 1 {name=p15 lab=ERR_AMP_CUR_BIAS}
C {lab_pin.sym} 2880 -1970 0 1 {name=p16 lab=VB3_CUR_BIAS}
C {lab_pin.sym} 2880 -2030 0 1 {name=p17 lab=V_CMFB_S4}
C {lab_pin.sym} 2880 -2070 0 1 {name=p18 lab=V_CMFB_S2}
C {lab_pin.sym} 2880 -1990 0 1 {name=p19 lab=VB2_CUR_BIAS}
C {devices/gnd.sym} 3360 -1880 0 0 {name=l7 lab=GND}
C {devices/vdd.sym} 3360 -2160 0 0 {name=l8 lab=VDD}
