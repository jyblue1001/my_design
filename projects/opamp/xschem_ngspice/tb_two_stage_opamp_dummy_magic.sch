...
color=7
node=i(@m.x1.x20.msky130_fd_pr__pfet_01v8[id])}
...
color=6
node="\\"vout+ deriv()\\""}
N 4190 -3710 4190 -3660 {lab=VIN-}
N 4340 -3710 4340 -3660 {lab=VIN+}
N 4520 -2930 5080 -2930 {lab=VOUT-}
...
N 4070 -3080 4220 -3080 {lab=VIN+}
N 4070 -3330 4070 -3080 {lab=VIN+}
N 3850 -3330 4070 -3330 {lab=VIN+}
C {devices/vsource.sym} 3730 -3630 0 0 {name=VDD value="pwl(0 0 3us 0 4us 1.8)"  savecurrent=false
* "1.8 AC 1"  "sin(1.8 0.001 10k)" 1.8}
C {devices/gnd.sym} 3730 -3600 0 0 {name=l3 lab=GND}
C {devices/vdd.sym} 3730 -3660 0 0 {name=l4 lab=VDD}
C {sky130_fd_pr/corner.sym} 3420 -3670 0 0 {name=CORNER only_toplevel=false corner=tt}
C {simulator_commands_shown.sym} 1700 -3770 0 0 {name=COMMANDS
simulator=ngspice
only_toplevel=false 
value="
...
"}
C {lab_pin.sym} 5080 -3010 2 0 {name=p6 lab=VOUT+}
C {lab_pin.sym} 5080 -2930 0 1 {name=p7 lab=VOUT-}
C {lab_pin.sym} 3850 -3330 2 1 {name=p10 lab=VIN+}
C {lab_pin.sym} 3850 -3250 0 0 {name=p11 lab=VIN-}
C {devices/gnd.sym} 3550 -2810 0 0 {name=l2 lab=GND}
C {devices/vsource.sym} 4190 -3630 0 1 {name=V2 value="sin(1.24 -0.001 100k)" savecurrent=false
* "1.24 AC -1"
* "sin(1.24 -0.001 1Meg)"
* "sin(0.2 -0.001 1Meg)" 
* "pulse(1.24 1.04 0ns 2ns 2ns 48ns 100ns)"
* "pulse(1.24 1.23 0ns 2ns 2ns 48ns 100ns)" "pulse(1.24 1.23 0ns 0.8ns 0.8ns 19.2ns 40ns)"}
C {devices/vsource.sym} 4340 -3630 0 0 {name=V1 value="sin(1.24 0.001 100k)" savecurrent=false
* "1.24 AC 1"
* "sin(1.24 0.001 1Meg)"  
...
C {devices/gnd.sym} 4190 -3600 0 0 {name=V3 value="pulse(1.241 1.239 0ns 10ns 10ns 240ns 500ns)" savecurrent=false
* "1.24 AC -1"
* "sin(1.24 -0.001 100k)"
* "sin(0.2 -0.001 1Meg)" "sin(1.24 -0.001 1Meg)"
* "pwl(0 1.24 3us 1.24 3.01us 1.239)"}
C {devices/gnd.sym} 4340 -3600 0 0 {name=V4 value="pulse(1.241 1.239 0ns 10ns 10ns 240ns 500ns)" savecurrent=false
* "1.24 AC -1"
* "sin(1.24 -0.001 100k)"
* "sin(0.2 -0.001 1Meg)" "sin(1.24 -0.001 1Meg)"
* "pwl(0 1.24 3us 1.24 3.01us 1.239)"}
C {lab_pin.sym} 4340 -3710 0 1 {name=p2 lab=VIN+}
C {lab_pin.sym} 4190 -3710 0 0 {name=p3 lab=VIN-}
C {sky130_fd_pr/cap_mim_m3_1.sym} 4890 -3090 2 1 {name=C1 model=cap_mim_m3_1 W=23 L=23 MF=1 spiceprefix=X}
C {devices/gnd.sym} 4890 -3120 2 1 {name=l13 lab=GND}
C {sky130_fd_pr/cap_mim_m3_1.sym} 4890 -2850 0 0 {name=C2 model=cap_mim_m3_1 W=23 L=23 MF=1 spiceprefix=X}
C {devices/gnd.sym} 4890 -2820 0 0 {name=l14 lab=GND}
