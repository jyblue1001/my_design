...
C {devices/res.sym} 670 -290 0 0 {name=R1
value=1k
footprint=1206
device=resistor
m=1}
...
C {devices/res.sym} 880 -560 0 0 {name=R2
value=1k
footprint=1206
device=resistor
m=1}
...
C {devices/res.sym} 410 -600 0 0 {name=R3
value=1k
footprint=1206
device=resistor
m=1}
C {devices/res.sym} 670 -590 0 0 {name=R4
value=1k
footprint=1206
device=resistor
m=1}
