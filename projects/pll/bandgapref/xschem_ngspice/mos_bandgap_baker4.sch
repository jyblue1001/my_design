...
C {devices/code.sym} 70 -480 0 0 {name=STIMULI only_toplevel=false value="
...
C {devices/lab_pin.sym} 650 -390 0 0 {name=p3 sig_type=std_logic lab=Vin-}
...
C {devices/vdd.sym} 670 -450 3 1 {name=l5 lab=VDD}
C {devices/gnd.sym} 790 -450 3 1 {name=l8 lab=GND
W=4}
C {/foss/designs/my_design/projects/pll/bandgapref/xschem_ngspice/opamp_bandgap2.sym} 730 -450 3 0 {name=x1}
...
C {devices/lab_pin.sym} 820 -390 0 0 {name=p1 sig_type=std_logic lab=Vin+}
...
C {sky130_fd_pr/res_xhigh_po_0p69.sym} 1220 -280 0 0 {name=R2
L=3.1
model=res_xhigh_po_0p69
spiceprefix=X
mult=1}
C {sky130_fd_pr/res_xhigh_po_0p69.sym} 870 -240 0 0 {name=R1
L=0.69
model=res_xhigh_po_0p69
spiceprefix=X
mult=1}
C {devices/ammeter.sym} 480 -620 0 0 {name=Vmeas3 savecurrent=true spice_ignore=0
W=4}
