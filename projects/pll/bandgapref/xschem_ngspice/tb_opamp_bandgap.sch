...
C {devices/vsource.sym} 170 -120 0 0 {name=Vin1 value=0.9 savecurrent=false}
...
C {devices/vsource.sym} 270 -120 0 0 {name=Vin2 value="sin(0.9 0.0001 1k)" savecurrent=false}
C {devices/code.sym} 230 -530 0 0 {name=Stimuli only_toplevel=false value="
...
C {/foss/designs/my_design/projects/pll/bandgapref/xschem_ngspice/opamp_bandgap.sym} 180 -310 0 0 {name=x1}
