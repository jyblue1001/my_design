...
N 1520 -920 2310 -920 {lab=V_OUT}
N 1150 -920 1350 -920 {lab=x}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 2000 -1300 0 0 {name=C1 model=cap_mim_m3_1 W=8.75 L=6.3 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 2000 -660 2 0 {name=C2 model=cap_mim_m3_1 W=3.1 L=2.6 MF=1 spiceprefix=X}
...
C {iopin.sym} 630 -1500 0 0 {name=p2 lab=x}
C {iopin.sym} 630 -1460 0 0 {name=p4 lab=V_OUT}
C {devices/ipin.sym} 510 -1340 0 0 {name=p7 lab=UP_input}
C {devices/ipin.sym} 510 -1300 0 0 {name=p8 lab=DOWN_input}
C {devices/ipin.sym} 510 -1260 0 0 {name=p5 lab=opamp_out}
