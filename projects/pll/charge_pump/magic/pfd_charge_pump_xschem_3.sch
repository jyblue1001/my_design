...
B 2 400 -3730 1760 -3060 {flags=graph
y1=2.6e-18
y2=0.00014
ypos1=0
ypos2=2
...
color="6 7"
node="i(@m.x5.xm27.msky130_fd_pr__pfet_01v8[id])
i(@m.x5.xm30.msky130_fd_pr__nfet_01v8[id])"}
...
N 790 -5570 790 -5530 {
lab=I_IN}
N 1000 -4910 1290 -4910 {lab=V_OUT}
...
"}
C {devices/gnd.sym} 1180 -4750 0 0 {name=l1 lab=GND
value="
...
"}
C {/foss/designs/my_design/projects/pll/charge_pump/magic/loop_filter_magic.sym} 1180 -4830 0 0 {name=x1}
C {/foss/designs/my_design/projects/pll/charge_pump/magic/pfd_cp_xschem.sym} 900 -4910 0 0 {name=x5}
