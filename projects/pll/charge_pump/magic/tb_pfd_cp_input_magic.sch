...
C {devices/code.sym} 230 -388.75 0 0 {name=Testbench only_toplevel=false value="
...
C {/foss/designs/my_design/projects/pll/pfd/magic/phase_frequency_detector_magic.sym} 810 -310 0 0 {name=x1}
