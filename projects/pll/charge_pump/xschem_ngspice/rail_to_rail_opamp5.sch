...
C {sky130_fd_pr/pfet_01v8.sym} 200 -660 0 1 {name=M15
L=0.15
W=2
nf=2
mult=1
...
C {devices/ammeter.sym} 180 -410 0 0 {name=Vmeas savecurrent=true spice_ignore=0}
...
C {sky130_fd_pr/pfet_01v8.sym} 200 -510 0 1 {name=M14
L=0.15
W=2
nf=2
mult=1
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 1060 -200 0 0 {name=C1 model=cap_mim_m3_1 W=10 L=10 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 1060 -680 0 0 {name=C2 model=cap_mim_m3_1 W=10 L=10 MF=1 spiceprefix=X}
