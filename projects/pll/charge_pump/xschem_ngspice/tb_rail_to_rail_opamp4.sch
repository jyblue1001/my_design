...
color=5
node=vout}
B 2 230 -2530 1700 -1770 {flags=graph
y1=-170
y2=180
ypos1=0
ypos2=2
...
color=4
node=ph(vout)}
B 2 1760 -2530 3230 -1770 {flags=graph
y1=0
y2=1.8
ypos1=0
ypos2=2
...
C {devices/code.sym} 580 -340 0 0 {name=Stimuli only_toplevel=false value="
...
device=resistor
m=1}
C {/foss/designs/my_design/projects/pll/charge_pump/xschem_ngspice/rail_to_rail_opamp4.sym} 1210 -660 0 0 {name=x1}
C {devices/isource.sym} 340 -480 2 0 {name=I0 value=450n}
C {devices/gnd.sym} 340 -450 0 0 {name=l7 lab=GND}
C {devices/lab_pin.sym} 340 -560 0 1 {name=p4 sig_type=std_logic lab=I_IN}
C {devices/lab_pin.sym} 1120 -550 0 0 {name=p1 sig_type=std_logic lab=I_IN}
