...
C {devices/lab_pin.sym} 2790 290 0 1 {name=p1 sig_type=std_logic lab=V_OUT120}
C {/foss/designs/my_design/projects/pll/divider/xschem_ngspice/FF_comp_sw_divide3_2.sym} 2340 290 0 0 {name=x5}
C {/foss/designs/my_design/projects/pll/divider/xschem_ngspice/FF_comp_sw_divide5_2.sym} 2640 290 0 0 {name=x6}
C {devices/gnd.sym} 2340 350 0 0 {name=l10 lab=GND}
C {devices/vdd.sym} 2340 230 0 0 {name=l11 lab=VDD}
C {devices/gnd.sym} 2640 350 0 0 {name=l12 lab=GND}
C {devices/vdd.sym} 2640 230 0 0 {name=l13 lab=VDD}
...
C {/foss/designs/my_design/projects/pll/divider/xschem_ngspice/FF_comp_sw_divide2_2.sym} 1430 290 0 0 {name=x2}
C {devices/gnd.sym} 1740 350 0 0 {name=l21 lab=GND}
C {devices/vdd.sym} 1740 230 0 0 {name=l22 lab=VDD}
C {devices/gnd.sym} 2040 350 0 0 {name=l23 lab=GND}
C {devices/vdd.sym} 2040 230 0 0 {name=l24 lab=VDD}
C {devices/lab_wire.sym} 1530 290 0 1 {name=p4 sig_type=std_logic lab=V_OUT2}
C {devices/lab_wire.sym} 1840 290 0 1 {name=p6 sig_type=std_logic lab=V_OUT4}
C {devices/lab_wire.sym} 2140 290 0 1 {name=p8 sig_type=std_logic lab=V_OUT8}
C {devices/lab_wire.sym} 2440 290 0 1 {name=p9 sig_type=std_logic lab=V_OUT24}
C {/foss/designs/my_design/projects/pll/vco/xschem_ngspice/current_starved_VCO8.sym} 1570 -160 0 0 {name=x1}
C {/foss/designs/my_design/projects/pll/divider/xschem_ngspice/FF_comp_sw_divide2_2.sym} 1740 290 0 0 {name=x3}
C {/foss/designs/my_design/projects/pll/divider/xschem_ngspice/FF_comp_sw_divide2_2.sym} 2040 290 0 0 {name=x4}
