...
Group{
	...
	CAPM = Region[27];
	Dielec_CAPM = Region[28];
	Metal_4 = Region[29];
	Dielec_Metal_4 = Region[30];
	influx = Region[31];
	fixtemp = Region[32];
	Vol_The = Region[{N-Well, Dielec_N-Well, Local_Interconnect_Contact, Dielec_Local_Interconnect_Contact, Diffusion, Dielec_Diffusion, Tap, Dielec_Tap, Polysilicon, Dielec_Polysilicon, Local_Interconnect, Dielec_Local_Interconnect, Metal_Contact, Dielec_Metal_Contact, Metal_1, Dielec_Metal_1, Via, Dielec_Via, Metal_2, Dielec_Metal_2, Via_2, Dielec_Via_2, Metal_3, Dielec_Metal_3, Via_3, Dielec_Via_3, CAPM, Dielec_CAPM, Metal_4, Dielec_Metal_4}];
	...
	Flux[] = Pmax / 1.4975e-11 * TimeFct[];       // Power density [W/m^2]
	qVol[] = 0;
	t0 = 0;
	t1 = timemax;
	dt = dtime;
