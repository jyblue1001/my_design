...
N 1890 -730 1890 -680 {
lab=VDD_FM_SOURCE}
C {devices/vsource.sym} 1770 -620 0 0 {name=V1 value=1.8 savecurrent=false}
...
C {/foss/designs/my_design/projects/pll/vco/xschem_ngspice/current_starved_VCO3.sym} 3630 -150 0 0 {name=x1}
...
C {devices/vsource.sym} 1890 -550 0 0 {name=V2 value=1.8 savecurrent=false}
C {devices/gnd.sym} 1890 -520 0 0 {name=l19 lab=GND}
C {devices/lab_pin.sym} 1890 -730 0 1 {name=p8 sig_type=std_logic lab=VDD_FM_SOURCE}
C {devices/vsource.sym} 1890 -650 0 0 {name=V4 value="sin(0 10m 1Meg)" savecurrent=false}
C {devices/lab_pin.sym} 2050 70 0 0 {name=p12 sig_type=std_logic lab=VDD_FM_SOURCE}
