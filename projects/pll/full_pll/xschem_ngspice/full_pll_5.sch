...
color=5
node=v_cont}
B 2 160 -1710 5790 -160 {flags=graph
y1=-0.042
y2=1.9
ypos1=0
ypos2=2
...
node="f_ref_inv
v_out120_inv"}
B 2 160 -40 5790 1510 {flags=graph
y1=-0.00012
y2=0.00021
ypos1=0
ypos2=2
...
color=6
node="\\"i(@m.x4.xm6.msky130_fd_pr__pfet_01v8[id]) i(@m.x4.xm9.msky130_fd_pr__nfet_01v8[id]) -\\""}
B 2 160 1630 5790 3180 {flags=graph
y1=-0.042
y2=1.8
ypos1=0
ypos2=2
...
C {devices/code.sym} 1100 -3950 0 0 {name=Stimuli only_toplevel=false value="
...
C {devices/vdd.sym} 2960 -3920 3 0 {name=l7 lab=VDD}
