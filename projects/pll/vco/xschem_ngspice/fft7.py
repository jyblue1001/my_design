...
# Reload the data
# file_path = 'tb_current_starved_VCO13.csv'
file_path = 'tb_current_starved_VCO13_2.csv'
...
# Filter data to include only values after 7 microseconds
start_time_us = 7  # in microseconds
...
plt.title('Lin Mag/Log Freq Spectrum w/ Dominant Frequencies Highlighted (After 7 µs)')
...
plt.title('Log Mag/Log Freq Spectrum (After 7 µs)')
plt.xlabel('Frequency (Hz)')
