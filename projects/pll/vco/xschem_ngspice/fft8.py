...
data = pd.read_csv('tb_current_starved_VCO13.csv', header=None)
...
# Plot the entire time-domain signal
...
# Convert the FFT result to decibels
signal_fft_db = 20 * np.log10(signal_fft)

# Calculate zero-crossing frequency for the signal
