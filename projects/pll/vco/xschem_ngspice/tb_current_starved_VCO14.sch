...
C {devices/vsource.sym} 630 -400 0 0 {name=V1 value=0.9 savecurrent=false}
...
C {/foss/designs/my_design/projects/pll/vco/xschem_ngspice/current_starved_VCO3.sym} 1050 -330 0 0 {name=x1}
...
C {/foss/designs/my_design/projects/pll/divider/xschem_ngspice/TSPC_FF_ratioed_divide2.sym} 1360 -330 0 0 {name=x2}
